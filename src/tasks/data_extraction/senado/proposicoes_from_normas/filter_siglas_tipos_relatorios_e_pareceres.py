...
with open("data/senado/metadados/sigla_tipos.json", "r", encoding="utf-8") as f:
...
with open("data/senado/metadados/sigla_tipos_relatorios_e_pareceres.json", "w", encoding="utf-8") as f:
